  ...
  test.describe('getCorrections', () => {
    ...
    test('retrieves existing tiles from PMTiles file', async ({ page }) => {
      ...
      for (const tile of tilesWithData) {
        const validLayers = ['to-add-osm', 'to-del-osm', 'to-add-osm-disp', 'to-del-osm-disp', 'to-add-osm-internal', 'to-del-osm-internal', 'to-add-ne', 'to-del-ne', 'to-add-ne-disp', 'to-del-ne-disp', 'to-add-ne-internal', 'to-del-ne-internal'];
